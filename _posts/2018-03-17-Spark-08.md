...
![](https://github.com/xiaocxt/xiaocxt.github.io/raw/master/assets/image/spark-join-1.png)
...
![](https://github.com/xiaocxt/xiaocxt.github.io/raw/master/assets/image/spark-join-2.png)
...
![](https://github.com/xiaocxt/xiaocxt.github.io/raw/master/assets/image/spark-join-3.png)
...
![](https://github.com/xiaocxt/xiaocxt.github.io/raw/master/assets/image/spark-join-4.png)

1. shuffle阶段：将两张大表根据join key进行重新分区，两张表数据会分布到整个集群，以便分布式并行处理。
2. sort阶段：对单个分区节点的两表数据，分别进行排序。
3. merge阶段：对排好序的两张分区表数据执行join操作。join操作很简单，分别遍历两个有序序列，碰到相同join key就merge输出，否则取更小一边。如下图所示：

![](https://github.com/xiaocxt/xiaocxt.github.io/raw/master/assets/image/spark-join-5.png)
